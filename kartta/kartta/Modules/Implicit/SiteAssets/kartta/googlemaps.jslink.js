...
window.jQuery || document.write('<script src="//code.jquery.com/jquery-latest.min.js"><\/script>')
...
jslinkGoogleMaps.PointValue.showMapDialog = function (fieldName) {
    ExecuteOrDelayUntilScriptLoaded(function () {
        ...
        var dialogUrl = _spPageContextInfo.webAbsoluteUrl + "/SiteAssets/kartta/Pages/GoogleMapPointDialog.aspx";
...
jslinkGoogleMaps.SpacialValue.showMapDialog = function () {
    ExecuteOrDelayUntilScriptLoaded(function () {
        ...
        var dialogUrl = _spPageContextInfo.webAbsoluteUrl + "/SiteAssets/kartta/Pages/GoogleMapSpacialDialog.aspx";
...
jslinkOverride.GoogleMaps.Functions.MdsRegisterTemplate = function () {
    ...
    var thisUrl = _spPageContextInfo.webServerRelativeUrl + "/SiteAssets/kartta/googlemaps.jslink.js";
